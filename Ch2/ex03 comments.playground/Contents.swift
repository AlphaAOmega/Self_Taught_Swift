...
/// - incorrectAge(age: Int): 나이가 -세 미만, 150세 초과인 경우 잘못된 나이로 인식하여
/// 오류로 처리
/// - unknown: 알 수 없는 오류
 ...
 * 이렇게도 됩니다.
 ...
 바를 세개 이상 하용하면 긴 줄로 문단을 나눠줍니다.
 
 ---
 
 언더바 또는 별표를 이용하면 텍스트를 강조할 수 있습니다.
 ...
 바를 사용하면 바로 위 텍스트를 중간크기 제목으로 표시해줍니다. 텍스트 앞에 #을 두개 붙여줘도 동일한 효과를 냅니다.
 
 사용 예
 ----
 다른 텍스트보다 네 칸 이상 들여쓰기 하면 코드 블록을 만들어줍니다. 또한 강세표(backquote, ')를 세개 이상 한 쌍으로 묶어도 코드 블록을 만들어줍니다.
