...
// 20-5 Receivable, Sendable 프로토콜과 두 프로토콜을 준수하는 Message와 Mail 클래스
// 무언가를 수신받을 수 있는 기능
protocol Receivable {
...
class Message: Sendable, Receivable {
    ...
    func send(data: Any) {
        ...
        // 수신가능한 인스턴스의 received 메서드를 호출합니다.
...
// Mail과 Message 모두 Sendable과 receivable 프로토콜을 준수하므로 서로 주고받을 수 있습니다.
myMail.to = yourMail
