...
/*
 ...
 extension 확장할 타입 이름: 프로토콜 1, 프로토콜 2 {
    // 프로토콜 요구사항 구현
 }
 */
...
print(centerRect.origin, centerRect.size)   // Point(x: 2.5, y: 2.5) Size(width: 3.0, height: 3.0)
