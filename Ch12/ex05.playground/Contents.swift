...
public struct SomeType {
    ...
    // 설정자는 비공개 접근수준 - // 접근수준(set)처럼 표현하면 설정자의 접근수준만 더 낮도록 지정해줄 수 있습니다.
    // (예: private(set))
...
// someInstance.publicGetOnlyStoredProperty = 100 - 오류 발생(set이 private임)
...
// someInstance.internalGetOnlyComputedProperty = 100 - 오류 발생(set이 private임)
